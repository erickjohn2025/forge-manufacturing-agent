...
type Config = {
  ...
  manufacturerPaymentPhone?: string; canManagePayments?: boolean; paymentMode?: string;
};
...
export function ConfigurationView() {
  ...
  useEffect(() => { apiFetch<Config>("/api/configuration").then((value) => { setConfig((old) => ({ ...old, ...value })); setPaymentPhone(value.manufacturerPaymentPhone ?? ""); }).catch(() => {}); }, []);
